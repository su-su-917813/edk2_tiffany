...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x13d1c8d2, 0xc995, 0x4fd2, {0xa1, 0x69, 0x73, 0x4d, 0xdc, 0x12, 0xfd, 0x23}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SetCPUFreqDxe";
...
{
  return SetCPUFreqDxeMain (ImageHandle, SystemTable);
}
