...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x964EFA94, 0x9929, 0x4EF8, {0x9E, 0x68, 0x8F, 0x6F, 0x6F, 0xA6, 0x2E, 0x63}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "KernelErrataPatcher";
...
{
  return KernelErrataPatcherEntryPoint (ImageHandle, SystemTable);
}
