...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xBAD0554E, 0x22E9, 0x4D83, {0x9A, 0xFD, 0xCC, 0x87, 0x72, 0x7A, 0x1A, 0x45}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gRenegadePkgTokenSpaceGuid = { 0xa03432a9, 0x9683, 0x4743, { 0xb1, 0x64, 0xf3, 0x8e, 0x16, 0x0f, 0x18, 0x88 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdDeviceVendor[7] = {88, 105, 97, 111, 109, 105, 0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdDeviceVendor = 7;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdDeviceProduct[6] = {77, 105, 32, 53, 88, 0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdDeviceProduct = 6;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdDeviceCodeName[8] = {116, 105, 102, 102, 97, 110, 121, 0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdDeviceCodeName = 8;
