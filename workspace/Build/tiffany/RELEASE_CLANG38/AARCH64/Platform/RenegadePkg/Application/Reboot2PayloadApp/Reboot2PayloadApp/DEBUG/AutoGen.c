...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x801a189c, 0xe4a4, 0x4195, {0x85, 0xc2, 0x64, 0xc5, 0x45, 0x0a, 0x15, 0xee}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Reboot2PayloadApp";
...
{
  return Reboot2PayloadAppEntryPoint (ImageHandle, SystemTable);
}
