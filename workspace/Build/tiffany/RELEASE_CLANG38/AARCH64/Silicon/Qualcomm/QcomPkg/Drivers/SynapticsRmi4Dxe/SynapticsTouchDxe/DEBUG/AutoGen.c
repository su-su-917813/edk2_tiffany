...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xf0d87c5e, 0x4d5d, 0x4fb5, {0x93, 0x9f, 0xa6, 0x76, 0x8a, 0xe8, 0xa3, 0x09}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SynapticsTouchDxe";
...
{
  return SynaInitialize (ImageHandle, SystemTable);
}
