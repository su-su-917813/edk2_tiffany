...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xf0d87c5e, 0x4d5d, 0x4fb5, {0x93, 0x9f, 0xa6, 0x76, 0x8a, 0xe8, 0xa3, 0x10}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SynapticsTouchDeviceDxe";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gQcomI2cProtocolGuid = { 0xb27ae8b1, 0x3e10, 0x4d07, { 0xab, 0x5c, 0xeb, 0x9a, 0x6d, 0xc6, 0xfa, 0x8f } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gQcomTlmmProtocolGuid = { 0xad9aec18, 0x7bf0, 0x4809, { 0x9e, 0x96, 0x30, 0x12, 0x30, 0x9f, 0x3d, 0xf7 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gSynapticsTouchDeviceProtocolGuid = { 0xf6ba192f, 0x9ee4, 0x4e3b, { 0xb1, 0x7a, 0xda, 0x75, 0x40, 0x3f, 0xa5, 0xa7 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdTouchCtlrAddress = _PCD_VALUE_PcdTouchCtlrAddress;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdTouchCtlrResetPin = _PCD_VALUE_PcdTouchCtlrResetPin;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdTouchCtlrIntPin = _PCD_VALUE_PcdTouchCtlrIntPin;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdTouchCtlrI2cDevice = _PCD_VALUE_PcdTouchCtlrI2cDevice;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdTouchMinX = _PCD_VALUE_PcdTouchMinX;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdTouchMaxX = _PCD_VALUE_PcdTouchMaxX;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdTouchInvertedX = _PCD_VALUE_PcdTouchInvertedX;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdTouchMinY = _PCD_VALUE_PcdTouchMinY;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdTouchMaxY = _PCD_VALUE_PcdTouchMaxY;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdTouchInvertedY = _PCD_VALUE_PcdTouchInvertedY;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdTouchCtlrVddPin = _PCD_VALUE_PcdTouchCtlrVddPin;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdTouchCtlrVddIoPin = _PCD_VALUE_PcdTouchCtlrVddIoPin;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdTouchCtlrVddPinActiveLow = _PCD_VALUE_PcdTouchCtlrVddPinActiveLow;
...
{
  return SynaDeviceInitialize (ImageHandle, SystemTable);
}
