...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xF1249C4E, 0x8995, 0x4BB6, {0x9D, 0x44, 0xE0, 0xCD, 0x4F, 0xF7, 0x09, 0xFC}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "KernelFdtDxe";
...
{
  return KernelFdtMain (ImageHandle, SystemTable);
}
